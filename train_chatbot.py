...
def build_dataset(use_stored_dictionary=False):
    ...
    if not use_stored_dictionary:
        ...
        dict_l1 = create_indexed_dictionary(filt_clean_sen_l1, dict_size=30000, storage_path=path_l1_dict)
        dict_l2 = create_indexed_dictionary(filt_clean_sen_l2, dict_size=30000, storage_path=path_l2_dict)
    else:
...
def train():
    with tf.Session() as sess:
        ...
        max_steps = 5000 #change to a larger number later
